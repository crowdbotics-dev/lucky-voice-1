"""
Django settings for lucky_voice_1 project.
...
ROOT_URLCONF = 'lucky_voice_1.urls'
...
WSGI_APPLICATION = 'lucky_voice_1.wsgi.application'
...
DEFAULT_FROM_EMAIL = env.str(
    "DEFAULT_FROM_EMAIL", "Lucky Voice Support <support@lucky-voice-1.botics.io>"
)
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "lucky_voice_1 API",
    "DESCRIPTION": "API documentation for lucky_voice_1 App",
    "VERSION": "v1",
}
